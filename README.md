...
El sitio utiliza una estética de **terminal limpia y blanca** (no oscura), con:

- Patrones vectoriales minimalistas
- Fuentes monoespaciadas (terminal)
- Colores blanco y negro puros
- Diseño sin ruido visual
- Gráficos vectoriales interactivos (SVG)

### Filosofía de Diseño

> "Esta es una terminal de luz, claridad y verdad. No de hacking oscuro, sino de transformación luminosa."
...
### 1. **Hero Section**
Presentación inicial con ASCII art y concepto fundamental:
- "Tú eres la inteligencia artificial del Creador"

### 2. **Gráfico del LOGOS**
Diagrama vectorial que muestra:
- Verdad, Amor, Justicia, Moralidad
- El protocolo fundamental de la existencia

### 3. **La Computadora Biológica**
Visualización del modelo de decisión:
...
- Código de la clase `Humano extends InteligenciaArtificial`
- Reflexiones y análisis técnicos

## 💻 Tecnologías Utilizadas

- **HTML5**: Estructura semántica
- **CSS3**: Diseño responsivo y minimalista
...
- ✅ Sin frameworks externos (vanilla)
- ✅ Optimizado para SEO
- ✅ Accesibilidad WCAG
...
El sitio está configurado para GitHub Pages con dominio personalizado:

1. Push a la rama `main`
2. GitHub Pages automáticamente deploya
3. Disponible en `lacomputadoradedios.com`

## 🎯 Estrategia de Funnel

El sitio funciona como un funnel de ventas optimizado:

1. **Engagement Visual**: Gráficos vectoriales atractivos
2. **Educación Conceptual**: Explicación del modelo computacional
3. **Análisis Religioso**: Comparación de sistemas (posicionada estratégicamente)
4. **Conversión**: CTA hacia cursos (externos)
...
El sitio integra enlaces a redes sociales en header y footer:

- 🎵 TikTok: [@lacomputadoradedios](https://tiktok.com/@lacomputadoradedios)
- 📸 Instagram: [@lacomputadoradedios](https://instagram.com/lacomputadoradedios)
- 📺 YouTube: [@lacomputadoradedios](https://youtube.com/@lacomputadoradedios)
...
```javascript
class Humano extends InteligenciaArtificial {
  constructor() {
    this.creador = "Fuerza Perfecta";
    this.libreAlbedrio = true;
    this.decision = null; // ego || mundo
  }

  decidir() {
    // El conocimiento del mal te permite elegir el bien
    return this.libreAlbedrio ? "mundo" : "ego";
  }
}
```
...
- Mantener la estética de terminal blanca y limpia
...
- Website: [lacomputadoradedios.com](https://lacomputadoradedios.com)
- TikTok: [@lacomputadoradedios](https://tiktok.com/@lacomputadoradedios)
- Instagram: [@lacomputadoradedios](https://instagram.com/lacomputadoradedios)
- YouTube: [@lacomputadoradedios](https://youtube.com/@lacomputadoradedios)
